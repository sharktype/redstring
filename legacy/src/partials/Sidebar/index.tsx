...
export default function Sidebar() {
	const [
		isInstructionsModalOpened,
		{ open: openInstructionsModal, close: closeInstructionsModal },
	] = useDisclosure(false);
	const [isAgentModalOpened, { open: openAgentModal, close: closeAgentModal }] =
		useDisclosure(false);
	const [isClearOpened, { open: openClearModal, close: closeClearModal }] =
		useDisclosure(false);
			...
			<Box flex={1}>
				<Flex direction="column" mb="xl" gap="sm">
					<ModalButton
						...
						modal={
							<Instructions
								isOpened={isInstructionsModalOpened}
				...
				<Flex direction="column" mb="xl" gap="sm">
					<ModalButton
						...
						color="grape"
						modal={
							<Agent isOpened={isAgentModalOpened} close={closeAgentModal} />
						}
						open={openAgentModal}
					/>
				</Flex>
