		...
		<>
			<Group grow align="start" gap="xs">
				<Group gap={4} wrap="nowrap">
					...
					/>
					<LockIcon
						isLocked={locks.weight}
						toggle={() => toggleLock("weight")}
					/>
				</Group>
				<Group gap={4} wrap="nowrap">
					<Select
				...
				<Group gap={4} wrap="nowrap">
					...
					/>
					<LockIcon
						isLocked={locks.height}
						toggle={() => toggleLock("height")}
					/>
				</Group>
			</Group>
			...
			<Group grow align="start" gap="xs">
				<Group gap={4} wrap="nowrap">
					<TextInput
						...
						onChange={(event) =>
							setAppearance({
								eyeShape: event.currentTarget.value,
							})
						}
						disabled={locks.eyeShape}
						style={{ flex: 1 }}
					/>
					<LockIcon
						isLocked={locks.eyeShape}
						toggle={() => toggleLock("eyeShape")}
					/>
				</Group>
				<Group gap={4} wrap="nowrap">
					<TextInput
						label="Eye Colour"
						placeholder="e.g. blue, hazel, grey"
						value={appearance?.eyeColour ?? ""}
						onChange={(event) =>
							setAppearance({
								eyeColour: event.currentTarget.value,
							})
						}
						disabled={locks.eyeColour}
						style={{ flex: 1 }}
					/>
					<LockIcon
						isLocked={locks.eyeColour}
						toggle={() => toggleLock("eyeColour")}
					/>
				</Group>
			</Group>
		</>
